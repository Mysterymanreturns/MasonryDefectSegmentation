...
def UNETrun(inno, savestate,savestate2, type1, network, test, encoder, dim, testimage, testmask, savetag):
 ...
 #   encoder_weights="imagenet",     # use `imagenet` pre-trained weights for encoder initialization
    ...
    d2 = torch.load(test+"/results/"+savestate2)
    Net2.load_state_dict(d2["state_dict"])
